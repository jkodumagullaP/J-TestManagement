...
using System.IO;
using CTWebsite.ConfigurationManagement.MyConfigurationMappings;
using CTWebsite.ConfigurationManagement;
using CTWebsite.FunctionalTesting;
//using CTWebsite.UI.SwdMain;
...
namespace CTWebsite.UI
{
    public class SwdMainPresenter
    {
        ...
        private NewTest view;// =new NewMain() ;
        ...
        public void InitView(NewTest view)
        {
            this.view = view;
        ...
        public void SwitchToFrame(BrowserPageFrame frame)
        {
        ...
        public void OpenSwitchToFrameCodeHelperPopup(BrowserPageFrame currentFrame)
        {
