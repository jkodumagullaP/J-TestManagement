...
namespace CTWebsite.UI
{
    public partial class JavaScriptEditorView //: UserControl, IView
    {
        ...
        public void UpdateFileEditor(string fileContent)
        {
        ...
        {
            return null;// txtJavaScriptEditor.Text;
        }

        public void AppendConsole(string consoleOut)
        {
            //txtOutputConsole.AppendText(consoleOut + "\r\n");
        }

        public void SetControlsToEnabledState(bool isEnabled)
        {
