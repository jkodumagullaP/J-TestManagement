...
namespace CTWebsite.UI
{
    public partial class PageObjectDefinitionView// : UserControl, IView
    {
        ...
        //public void UpdateExistingPageDefinition(TreeNode existingNode, WebElementDefinition element)
        //{
        //    var action = (MethodInvoker)delegate
        //    {
        ...
        //public void DeleteExistingElementFromPage(TreeNode existingNode) {
        ...
        public void UpdateLastCallStat(string elapsedTime)
        {
        ...
        ////public void SetPageObjectFiles(string[] files)
        ////{
        ...
        ////public void NotifyOnSaveError(string errorMessage, string targetFile)
        ////{
        ...
        ////public void NotifyOnLoadError(string errorMessage, string targetFile)
        ////{
        ...
        ////public void ClearPageObjectTree()
        ////{
        ...
        internal string GetPageObjectName()
        {
            ...
            //cbPageObjectFiles.DoInvokeAction(() =>
            //{
            pageObjectName = "text";// cbPageObjectFiles.Text;
           // });
