...
namespace CTWebsite.WebDriver.OpenQA.Selenium.Support.PageObjects
{
    /// <summary>
    /// Represents a proxy class for an element to be used with the PageFactory.
    /// </summary>
    public class WebElementProxy : IWebElement, ILocatable, IWrapsElement
    {
        ...
        {
            return null;// this.WrappedElement.GetProperty(propertyName);
        }
    }
}
