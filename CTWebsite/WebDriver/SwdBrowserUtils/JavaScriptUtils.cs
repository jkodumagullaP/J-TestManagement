...
using CTWebsite.WebDriver.SwdBrowserUtils;

namespace CTWebsite.WebDriver.SwdBrowserUtils
{
    public static class JavaScriptUtils
    {
        ...
        private static void InjectJSON2ObjectForWierdBrowsers(IWebDriver webDriver)
        {
            ...
            // JavaScript code to inject JSON into the webpage
            string script = @"
            var script = document.createElement('script');
            script.type = 'text/javascript';
            script.textContent = 'window.JSON2 = window.JSON;';
        ...
        ";
            ...
            //string javaScript = ReadJavaScriptFromFile(Path.Combine("JavaScript", @"D:\New Download\swd-recorder-3.13.0.2018.06.28\swd-recorder-3.13.0.2018.06.28\SwdPageRecorder\SwdPageRecorder.WebDriver\JavaScript\json2.js"));
        ...
        internal static void InjectVisualSearch(IWebDriver webDriver)
        {
           ...
           // MyLog.Write("InjectVisualSearch: Started");
            string javaScript = ReadJavaScriptFromFile(Path.Combine("JavaScript", @"D:\New Download\swd-recorder-3.13.0.2018.06.28\swd-recorder-3.13.0.2018.06.28\SwdPageRecorder\SwdPageRecorder.WebDriver\JavaScript\ElementSearch.js"));
            IJavaScriptExecutor jsExec = webDriver as IJavaScriptExecutor;
            ...
            if (!IsVisualSearchScriptInjected(webDriver))
            {
                ...
                (webDriver as IJavaScriptExecutor).ExecuteScript(javaScript);
            }
        ...
        public static bool IsVisualSearchScriptInjected(IWebDriver webDriver)
        {
            ...
            for (var i = 0; i < scripts.length; i++) {
                if (scripts[i].src.includes('visual-search.js')) {
                    return true;
                }
            }
            return false;
        ";
            ...
            // Execute the JavaScript code
            IJavaScriptExecutor js = (IJavaScriptExecutor)webDriver;
            return (bool)js.ExecuteScript(script);
