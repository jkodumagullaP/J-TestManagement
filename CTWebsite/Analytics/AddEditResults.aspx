<%@ Page Title="Add or Edit Test Results" Language="C#" MasterPageFile="~/ThreeColumn.Master" AutoEventWireup="true" CodeBehind="AddEditResults.aspx.cs" Inherits="OSTMSWebsite.Analytics.AddEditResults" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="Environments" runat="server" 
        ConnectionString="<%$ ConnectionStrings:QAAConnectionString %>" 
        SelectCommand="SELECT * FROM [Environments]">
    </asp:SqlDataSource>
        
    <asp:SqlDataSource ID="Browsers" runat="server" 
        ConnectionString="<%$ ConnectionStrings:QAAConnectionString %>" 
        SelectCommand="SELECT * FROM [Browsers]">
    </asp:SqlDataSource>   
...
<asp:FormView ID="fvTestResultDetails" 
        ...
        RunAt="server" CssClass="gvTestCaseList" Width="100%" 
