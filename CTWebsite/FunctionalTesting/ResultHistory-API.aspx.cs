...
{
    public partial class ResultHistoryAPI : System.Web.UI.Page
    {
        ...
        protected void FiltersChanged()
        {
            ...
            sqlSingleTestCaseHistory.SelectCommand = "SELECT  " // APITestResultsView.*,
            ...
            + " ,[testType] "
            + " ,rawReasonForStatus "
            + " ,dbo.UserProfiles.userFirstName + ' ' + dbo.UserProfiles.userLastName as TestedByFullName FROM [TestResultsView] left join dbo.aspnet_Users 	on dbo.TestResultsView.testedBy = aspnet_Users.UserName left join dbo.UserProfiles on aspnet_Users.userid = UserProfiles.userid WHERE (([projectAbbreviation] = @projectAbbreviation) AND ([testCaseId] = @testCaseId)) ";
