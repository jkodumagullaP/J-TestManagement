...
namespace CTWebsite.FunctionalTesting
{
    public partial class ResultHistory : System.Web.UI.Page
    {
        ...
        protected int gvResultHistoryStatusColumn
        {
            get
            {
                return AspUtilities.GetColumnIndexByHeaderText(gvResultHistory, "Status");
            }
        }
        ...
        protected int gvResultHistoryReasonForStatusColumn
        {
            get
            {
                return AspUtilities.GetColumnIndexByHeaderText(gvResultHistory, "Reason for Status");
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    //If there is a value in the projects querystring, use it to find the default environment
                    if (tbProjectAbbreviationValue != "" && tbProjectAbbreviationValue != null)
                    {
